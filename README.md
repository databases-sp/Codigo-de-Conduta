# Código de Conduta - Databases SP
...
**🔒 O Databases SP deve ser um lugar seguro e convidativo para pessoas independentemente de:**
...
-	Nenhum conteúdo de cunho comercial ou de captação de dados para disponibilização de gratuidades poderá ser postado, salvo ações que sejam divulgadas pelo time oficial do Databases SP, como inscrições para novos cursos ou ou eventos movidos para comunidade, pois garantimos a privacidade de seus dados.
